...
/* Definitions for peripheral AXI_GPIO_JE */
#define XPAR_AXI_GPIO_JE_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_JE_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_JE_DEVICE_ID 0
#define XPAR_AXI_GPIO_JE_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_JE_IS_DUAL 0
...
/* Canonical definitions for peripheral AXI_GPIO_JE */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_JE_DEVICE_ID
